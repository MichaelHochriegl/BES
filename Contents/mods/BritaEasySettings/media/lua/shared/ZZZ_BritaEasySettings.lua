...
function applySettings()
    ...
    GUNFIGHTER.OPTIONS.options = SandboxVars.BritaEasySettings;
...
function debugPrint()
    print("~!~!~!~!~!~!~!~!");
    print(SandboxVars.BritaEasySettings["drop3"])
    print(GUNFIGHTER.OPTIONS["drop3"]);
    print(GUNFIGHTER.OPTIONS["drop3"]);
end
Events.OnGameStart.Add(applySettings);
Events.OnEquipPrimary.Add(debugPrint);